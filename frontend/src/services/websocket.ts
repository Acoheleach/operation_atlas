...
import { GameRoom, ChatMessage, GameEvent } from '../types/game';
...
export class WebSocketService {
  ...
  subscribeToRoom(roomId: string): void {
    ...
    this.chatSubscription = this.client.subscribe(`/topic/rooms/${roomId}/chat`, (message) => {
  ...
  submitPuzzle(roomId: string, continent: string, answer: string, playerId: string): void {
    if (!this.connected) {
